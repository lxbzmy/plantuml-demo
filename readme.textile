...
bc. node_modules/closure-library/closure/bin/build/closurebuilder.py  --root=./  --namespace="cn.devit.util.PlantUmlEditor" --output_mode=compiled --compiler_jar=node_modules/google-closure-compiler/compiler.jar>goog_.js
